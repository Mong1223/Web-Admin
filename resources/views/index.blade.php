...
@section('content')
    <div class="container-fluid" style="margin-bottom: 1rem">
        <div class="row" style="margin-bottom: 2rem">
            <nav id="content-nav" class="col-md-1 d-none d-md-block sidebar sidebar-little">
                    ...
                    <ul class="nav flex-column">
                        @for($i=0;$i<Count($data['menu']);$i++)
                             <li class="row row-nav" style="height: auto">
                                 <div class="nav-item col-lg-8 col-md-6" style="cursor: pointer">
                                 ...
                                 <a class="col-lg-2 col-md-3 close delete-news-button" style="color: white" href="{{route('DeleteMenu',$data['menu'][$i]->ID)}}" aria-label="Close">
                                     <span aria-hidden="true">&times;</span>
                                 </a>
                                 <a class="col-lg-2 col-md-3" style="margin-top: 0.2rem" href="{{route('EditMenu',$data['menu'][$i]->ID)}}">
                                            ...
                                            @if($data['menus'][$i+$j]->Тип=='FEED_LIST')
                                                <a href="{{route('GetNews',[$data['menus'][$i+$j]->ID,$data['menus'][$i+$j]->ЯзыкПодчинённого])}}" style="color: #1b1e21; text-decoration: none">
                                                    <div style="border: 1px solid #d7dfe3; margin-bottom: 2rem">
                                                        <img style="width: 100%; height: 16rem" src="/images/fon{{rand(1,5)}}.jpg" alt="">
                                                        ...
                                                        <div class="row" style="margin-bottom: 0.6rem">
                                                            ...
                                                            <a class="btn btn-primary col-md-4 delete-news-button" href="{{route('DeleteMenu',$data['menus'][$i+$j]->ID)}}">
                                                                Удалить
                                                            </a>
                                                            <div class="col-md-1"></div>
                                                        </div>
