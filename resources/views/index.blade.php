                                ...
                                <div id="lvl2{{$i}}" class="lvl2">
                                    @for($j=0;$j<Count($data['menu']);$j++)
                                        @if($data['menu'][$j]['Родитель']==$data['menu'][$i]['Подчинённый'])
                                            <li class="row row-nav" style="height: auto; width: auto">
                                                <div class="nav-item col-md-8" style="cursor: pointer" onclick="submenushow({{$j}})">
                                                    @if($data['menu'][$j]['Тип']=='FEED_LIST')
                                                        <a href="{{route('GetNews', $data['menu'][$j]['Подчинённый'])}}" style="text-decoration: none;">
                                                ...
                                                <a class="col-md-2 close" style="color: white" href="{{route('DeleteMenu',$data['menu'][$j]['ID'])}}" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </a>
                                                <a class="col-md-2" style="margin-top: 0.2rem" href="{{route('EditMenu',$data['menu'][$j]['Подчинённый'])}}">
                                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="white" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"/>
                                                        <path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/>
                                                    </svg>
                                            ...
                                            <div id="lvl2{{$j}}" class="lvl2">
                                                        ...
                                                        <li class="row" style="height: auto">
                                                            <div class="nav-item col-md-8" style="cursor: pointer">
                                                                @if($elem3['Тип']=='FEED_LIST')
                                                                    <a class="getnews" href="{{route('GetNews', $elem3['Подчинённый'])}}" style="text-decoration: none; color: white">
                                                                        {{$elem3['Подчинённый']}}
                                                                    </a>
                                                                @else
                                                                    {{$elem3['Подчинённый']}}
                                                            ...
                                                            <a class="col-md-2 close" style="color: white" href="{{route('DeleteMenu',$elem3['ID'])}}" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </a>
                                                            <a class="col-md-2" style="margin-top: 0.2rem" href="{{route('EditMenu',$elem3['Подчинённый'])}}">
                                                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="white" xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"/>
                                                                    <path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/>
                                                                </svg>
                                                ...
                                                @if($data['menu'][$j]['Тип']=='LINKS_LIST')
                                                    <a href="{{route('CreateSubMenu',$data['menu'][$j]['ID'])}}" class="btn btn-primary" style="margin-bottom: 0.2rem">
                                                        Добавить пункт меню
                                                    </a>
                                                @endif
                                            </div>
                                    ...
                                    @if($data['menu'][$i]['Тип']=='LINKS_LIST')
                                        <a href="{{route('CreateSubMenu',$data['menu'][$i]['ID'])}}" class="btn btn-primary" style="margin-bottom: 0.2rem">
                                            Добавить пункт меню
                                        </a>
                                    @endif
                                </div>
