<div id="card-cont" class="container position-fixed fixed-top align-content-center d-none" style="top: 6rem">
                ...
                <div class="card-body">
                    <form name="messages">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                {{csrf_field()}}
                                <textarea id="text-message" class="form-control" name="text"></textarea>
