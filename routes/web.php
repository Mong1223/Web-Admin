...
Route::get('/userSet','UtilsController@userTable')->name('userSet')->middleware('auth');
Route::post('/editgroup/id={id}&idg={idg}', 'UtilsController@editUserTable')->name('editgroup')->middleware('auth');
Route::post('/addnewgroup', 'UtilsController@ADDUserTable')->name('addnewgroup')->middleware('auth');
Route::get('/deletegroup/id={id}',['as'=>'deletegroup','uses'=>'UtilsController@deleteGroup'])->middleware('auth');
Route::get('/users','UsersController@getUsers')->name('users')->middleware('auth');
Route::post('/users/uploadfile',['as'=>'upload','uses'=>'UsersController@uploadFiles'])->middleware('auth');
/*Route::get('/testick',function (){
