...
Route::get('/GetMenuByLang/lang={lang}',['as'=>'GetMenuByLang','uses'=>'MenuController@GetMenuByLang']);
Route::get('/GetSubMenu/id={id}&lang={lang}',['as'=>'GetSubMenu','uses'=>'MenuController@GetSubMenu']);
...
Route::get('/EditMenu/id={id}',['as'=>'EditMenu','uses'=>'MenuController@EditMenu']);
...
Route::get('/GetNews/menu={menuid}&lang={lang}',['as'=>'GetNews','uses'=>'PageController@GetNews']);
Route::get('/CreateNews/Menu={MenuName}&Page={PageName}',['as'=>'CreateNews','uses'=>'PageController@CreateNews']);
Route::get('/CreatePage/menuid={menuid}&lang={lang}',['as'=>'CreatePage','uses'=>'PageController@CreatePage']);
